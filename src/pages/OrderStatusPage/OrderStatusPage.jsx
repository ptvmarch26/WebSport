              ...
              {order.products.map((product, index) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    {/* <p className="text-sm text-gray-500">{product.product_id.varients.varient_color} - {product.product_id.varients.varient_size}</p> */}
...
//     activeTab === "all"
//       ? orders.result
//       : orders.result.filter((order) => order.result.order_status === activeTab);
